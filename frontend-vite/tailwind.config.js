  ...
  theme: {
    extend: {
      colors: {
        ...
        'gray-light': { // Added Light Gray Atoms
          100: "#FAFAFA",
          200: "#F5F5F5",
          300: "#E5E5E5",
          400: "#D4D4D4",
      ...
      fontSize: { // Based on Figma "Typography"
      ...
      spacing: { // Based on Figma "Space" section (assuming values are in px)
        '0': '0', 
      ...
      borderRadius: { // Assuming common values, adjust based on Figma if specific values are defined
        'none': '0',
        'sm': '0.125rem', // 2px
        'DEFAULT': '0.25rem', // 4px
        'md': '0.375rem', // 6px
